...
| 连载义务账本与 Hook 状态 | `$short-drama-develop` | 连续项目需要对铺垫、兑现和延期保持可核对的稳定 ID | 账本不替代单集剧本中的可见载体与行动后果 |
...
| 写前质量编译与剧本落点检查 | `$short-drama-write` | 新写、续写或大修时从已接受合同和近期剧本生成私有工作包、定位合同落点风险 | 不把派生简报或 warning 当成剧情 owner 或独立审查结论 |
